package com.news.common.jsonres;

/**
 * @author Bjergsen  Email:915681203@qq.com
 * @Description 响应结果枚举，用于提供给 R 返回给前端的
 * @create 2022-06-14-11:00
 */
...
public enum ResponseStatusEnum {
    ...
    SMS_NEED_WAIT_ERROR(505,false,"每分钟内只能发送一次验证码，请稍后再试！"),
    ...
    ADMIN_PASSWORD_ERROR(564, false, "密码两次输入不一致！"),
    ...
    SYSTEM_RESPONSE_NO_INFO(557, false, "服务器故障，请稍后重试..."),
    SYSTEM_ERROR_FEIGN(558, false, "客户端故障，请稍后重试..."),
    SYSTEM_ERROR_BLACK_IP(559, false, "请求系统过于繁忙，请稍后重试...");
